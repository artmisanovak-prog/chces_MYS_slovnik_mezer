...
Přečtěte si [pohádku o Pávovi](karty_ukazky/Pav/pohadka.md).
...
- Přečtení pohádky
- Identifikace "pávích ok" v našem týmu
- Mapování projekcí

**Část 2: Odtrhávání per** (40 min)
- Cvičení "Čím nejsme"
- Identifikace vlastních zkreslení
- Nácvik cizích perspektiv

**Část 3: Nové vidění** (20 min)
- Tvorba "antipávových" pravidel
- Závazek k diverzitě myšlení
...
**Plná verze obsahuje:**
- ✅ **Všech 12 úhlů** (včetně: Epistemologická krize, Semiotický kolaps, Kontaktní schizofrenie, atd.)
- ✅ **Kompletní workshop** s podrobným scénářem
- ✅ **Šablony:** Mapa projekcí, Empatický test, Antipávový manifest
