...
### <a name="obsah"></a>OBSAH

- [Pohádka](#pohadka)
- [Jádrová dysfunkce a 3 otázky](#jadro)
- [12 pracovních úhlů](#uhly)
- [Workshop 90 minut](#workshop)
- [Kreativní mód – ukázky](#kreativni-mod)
- [Diagnostická matice](#matice)
- [Jak kartu používat](#pouziti)
- [Propojení s dalšími kartami](#propojeni)
- [Licence](#licence)

---

### <a name="pohadka"></a>📘 POHÁDKA
...
1. **Q1:** Proč si bordeláři přestali všímat vlastního dvorku, a naopak moucha v něm okamžitě našla ráj?
2. **Q2:** Kde v našem týmu máme vlastní „moruši“ – místo, proces nebo zvyk, který je už tak dlouho nefunkční, že jsme si ho přestali všímat? Kdo by mohl být naší „mouchou“?
3. **Q3:** Co by se muselo stát, abychom my sami dokázali vidět svůj „dvorek“ očima mouchy – ne jako vlastní selhání, ale jako prostředí, které lze změnit?

[↑ Zpět na obsah](#obsah)

---

### <a name="uhly"></a>🧠 12 PRACOVNÍCH ÚHLŮ (ukázka)

**1. Absurdní úhel** (paradoxní realita)
...
**2. Jazykový úhel** (řeč ticha a bzukotu)
...
**3. Ironický úhel** (když se řešení stává problémem)
...
### <a name="workshop"></a>📋 WORKSHOP 90 MINUT (struktura)
...
### <a name="kreativni-mod"></a>🎨 KREATIVNÍ MÓD – UKÁZKY

Princip karty se dá otočit do pozitivního tónu a použít v marketingu, designu či firemní kultuře.

**1. Pro copywriting: „Hledači skrytých příležitostí“**
- **Insight:** Moucha vidí ráj tam, kde ostatní vidí průser.
- **Využití:** Kampaň pro firmu, která nachází řešení v místech, kde ostatní vidí slepou uličku.
- **Příklad:** „Zatímco jiní vidí nepořádek, my vidíme švédský stůl. Specialisté na objevování příležitostí.“

**2. Pro product design: „Design, který bzučí“**
- **Insight:** Malý, neignorovatelný impuls spustí velkou změnu.
- **Využití:** Produkt s vestavěným „bzukotem“, který jemně upozorní na přehlížené věci.
- **Příklad:** Aplikace, která jednou denně pošle otázku: „Na co jsi dnes zapomněl?“
...
### <a name="matice"></a>📊 DIAGNOSTICKÁ MATICE

| Dominantní úhel | Diagnóza | Intervence |
|---|---|---|
| **Absurdní** | Tým si zvykl na absurdní stav a považuje ho za normální. | Pozvat externího pozorovatele, ať popíše, co vidí. |
| **Jazykový** | V týmu panuje ticho o zásadních problémech. | Zavést „minutu bzukotu“ na každém meetingu. |
| **Ironický** | Systém profituje z chaosu. | Identifikovat, kdo z problému těží, a přesměrovat ho. |
| **Naivní** | Tým ztratil schopnost vidět věci poprvé. | Každý si zkusí roli nováčka a ptá se „proč?“. |

[↑ Zpět na obsah](#obsah)

---

### <a name="pouziti"></a>🚀 JAK KARTU POUŽÍVAT

1. Přečtěte **pohádku** – nahlas, společně.
2. Položte **3 diagnostické otázky** – každý odpovídá sám za sebe.
3. Analyzujte odpovědi podle **12 úhlů** – získáte profil týmu.
4. Podle převažujících úhlů vyberte **intervenci** z matice.
5. Proveďte **workshop** (90 minut) pro hlubší práci.
6. Využijte **kreativní mód** pro pozitivní inspiraci.

[↑ Zpět na obsah](#obsah)

---

### <a name="propojeni"></a>🔗 PROPOJENÍ S DALŠÍMI KARTAMI

| Karta | Vztah k Mouše |
|---|---|
| **Kocour** | Kocour problémy „sežere“ (ukončí je), moucha je zviditelní. |
| **Paroží** | Paroží sbírá „blesky“ pozornosti, moucha přináší „bzukot“. |
| **Osel** | Osel bloudí mezi hromadami, moucha si v tom udělá ráj. |
...
Plná komerční verze (včetně všech souborů a firemní licence) je dostupná za 25 000 Kč. Kontakt: [chcesmys@gmail.com](mailto:chcesmys@gmail.com)
